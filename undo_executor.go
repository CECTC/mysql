...
func NewMysqlUndoExecutor(undoLog sqlUndoLog) UndoExecutor {
	return UndoExecutor{sqlUndoLog: undoLog}
}

func (executor UndoExecutor) Execute(conn *mysqlConn) error {
...
func (executor UndoExecutor) dataValidationAndGoOn(conn *mysqlConn) (bool, error) {
...
func (executor UndoExecutor) queryCurrentRecords(conn *mysqlConn) (*schema.TableRecords, error) {
